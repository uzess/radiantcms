  ...
  <div class="container">
    <div class="row">
        ...
        <div class="top-bar">
          <ul class="details"> 
            ...
            <li>
              ...
              <a href="mail:care@sdmtnepal.org.np">mail@sdmtnepal.org.np</a>
            </li> 
            </ul>
        </div>
      </div><!--col-6-->
      <div class="col-md-6">
        <ul class="social">
            <li>
              <a href="http://www.pinterest.com" class="s8">Pintrest</a>
            </li> 
            <li>
              <a href="http://www.youtube.com" class="s7">Youtube</a></li>
             <li>
              <a href="http://www.vimeo.com" class="s6">Vimeo</a> </li>
            <li>
              <a href="http://www.twiiter.com" class="s5">Twitter</a> 
            </li> 
            <li>
              <a href="http://www.flickr.com" class="s3">Flicker</a> </li> 
            <li>
              <a href="http://www.facebook.com" class="s1">Facebook</a>
            </li> 
          </ul>
      </div><!--col-6-->
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">
        <img src="images/sm/logo-alt.png">
      </a>
    </div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="infromation.php">Information</a></li>
        ...
        <div class="col-md-12">
          <div class="decorated-title">
              <div class="decorated-title-inner">
                  ...
                  <h2 class="title"><a href="index.php">Home</a>&nbsp;//&nbsp;Contact</h2>
                  <div class="rules"></div><!-- /.rules-->
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="googlemap">    
          <iframe src="https://maps.google.ca/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=+&amp;q=205+Narayan+Gopal+Road,+Lazimpat,+Kathmandu&amp;ie=UTF8&amp;hq=&amp;hnear=Lazimpat+Rd,+Lazimpat,+Kathmandu,+Bagmati,+Central+Region+44600,+Nepal&amp;t=m&amp;z=14&amp;iwloc=A&amp;output=embed" height="500" width="100%" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>        
    </div><!--googlemap-->
    ...
    <div class="col-md-8">
      ...
      <h2 class="section_title_black">Share your words</h2>
        ...
        <form role="form" action="contact-form.php" data-ajax="1" method="POST" class="form-footer">
                        <div class="col-md">
                            <label class="label">Name</label>

                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input type="text" class="form-control" placeholder="Username" required="" title="Please Fill out this Field">
                            </div>
                        </div>
                        ...
                        <div class="col-md">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control ht-auto" rows="6" name="message" id="suscribe_message" placeholder="Message" required=""></textarea>
                            </div>
                        </div>
                        

                        <div class="col-md">
                            <button type="submit" class="btn-ultra" data-loading-text="Sending..."> Send
                            </button>
    ...
    <div class="col-md-4">
      ...
      <h2 class="section_title_black">We are here</h2>
          ...
          <div class="textwidget"><p>135 Spring Street<br>
                New York, NY</p>
                <p>
                  <strong>Phone:</strong> +370 123456789
                </p>

                <p>
                <strong>Fax:</strong> +370 123456789
                </p>

                <p>
                <strong>Email:</strong> <a href="mailto:care@sdmtnepal.org.np">care@sdmtnepal.org.np</a>
                </p>

                <p>
                <strong>Web: </strong><a href="http://www.sdmtnepal.org.np/" target="_blank">http://www.sdmtnepal.org.np</a>
                </p>
            </div>
      </div>
    ...
    <div class="container">
      <div class="col-md-12">
        <div id="donation-slider" class="flexslider">
          <ul class="slides">
            <li>
              <h3>Help Us build Charity Hospital </h3>
              <div class="d-price">$18,387</div>
              <div class="d-progress"><span style="width:70%"></span></div>
              <p>pledged of $200,000 Goal</p>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <p>
          ...
          <p>
             Made with &nbsp;<i class="fa fa-heart"></i>&nbsp; by ultrabyte.com.np
          </p>

        <div class="paymentMethodImg"> 
          <img height="30" src="images/sm/master_card.png" alt="img"/>
          <img height="30" src="images/sm/visa_card.png" alt="img"/>
          <img height="30" src="images/sm/paypal.png" alt="img"/> 
</div>
...
<div class="copyright">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="powred-by">
              Powred by:<a href="http://www.ultrabyte.com.np" target="_blank"><img src="images/sm/ultrabyte-logo.png" alt="ultrabyte"></a>
          </div>
        </div>
      </div>
    </div>
