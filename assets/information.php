        ...
        <div class="col-md-12">
          <div class="decorated-title">
              <div class="decorated-title-inner">
                  ...
                  <h2 class="title"><a href="">About us</a>&nbsp;//&nbsp;Information</h2>
                  <div class="rules"></div><!-- /.rules-->
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="mission-vission">
            <img src="images/md/child3.png" alt="pre" class="update-parent img-responsive alignleft imageborder size-full wp-image-72 img-responsive">
                        <p class="p-lg">
                           research based institution established in 2015 with the vision to
                            conserve nature and natural resources with the help of local bodies,
                            student research scholars,professionals devoted and energetic youths
                             from different places of the country.s,professionals devoted and energetic 
                             from different places of the country.The organization has been 
                             from different places of the country.The organization has been 
                             from different places of the country.The organization has been 
                             from different places of the country.The organization has been 
                             from different places of the country.The organization has been 
                             ...
                             from different places of the country.The organization has been 
                             from different places of the country.The organization has been 
                             working with determination in the field of natural disaster prevention 
                             environmental education,and biodiversity conservation since its 
                             establishment period. The organization has worked jointly with 
                             establishment period. The organization has worked jointly with 
                             establishment period. The organization has worked jointly with 
                          several national and international organizations for the sustainable.
            </p><!--p-lg-->
          
          
          <p class="p-lg"><strong>Xyz objective</strong>
          <ul class="list-check">
                <li>
