                                    ...
                                    <tr>
                                        <td class="bgborder"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                <tr>
                                                    <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td class="heading2">&nbsp;Manage Testimonials</td>
                                                            </tr>
                                                            <tr>
    ...
    if ($row['status'] == 0) {
        ...
        ?>
                                                                                ...
                                                                                <td valign="top">
                                                                                    ...
                                                                                    [<a href="#" onClick="javascript: if (confirm('This will permanently delete Testimonial details from database. Continue?')) {
                                                                                                document.location = 'testimonials.php?type=del&id=<?php echo $row['id']; ?>';
                                                                                            }">Delete</a>]														</td>
                                                                            </tr>
                                                                                    <?
                                                                                }
