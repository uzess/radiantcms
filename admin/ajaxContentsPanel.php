...
<textarea name="shortcontents" class="ckeditor" id="editor3"><?php echo $groupRow['shortcontents']; ?></textarea><br />
<textarea name="contents" class="ckeditor" id="editor4"><?php echo $groupRow['contents']; ?></textarea>
